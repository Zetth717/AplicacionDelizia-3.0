...
namespace CapaLogica
{
    public class LReparto
    {
        ...
        public List<Pedido> obtener_pedidos_tomados(string cedula) {
            string consulta = "SELECT pedidos.Id, clientes.Direccion, clientes.Nombre FROM pedidos INNER JOIN clientes ON clientes.Id = pedidos.Cliente WHERE pedidos.Estado = 2 AND pedidos.Repartidor = " + cedula;
